...
greetings_text = 'Приветствую, буду рад помочь вам по любому интересующему вопросу!'
goodbye_text = 'Был рад помочь вам, обращайтесь!'
complaint_text = 'Нам очень жаль за предоставленные неудобства при пользовании нашими услугами. Ваша жалоба зарегистрирована, ожидайте звонка от оператора'


tariffs_and_options_chat_support="-4599476097"
contract_chat_support="-4531938649"

def get_intent_reply_text(intent):
    intents = {
        'tariffchange' : 'изменить свой тариф',
        'optionschange' : 'добавить\убрать услуги',
        'createcontract' : 'заключить договор',
        'help' : 'обратиться в поддержку', 
        'complaint' : 'оставить жалобу'
    }
    return f'На основе вашего голосового сообщения наша служба определила, что, возможно, вы хотите {intents.get(intent[1])}. Если это так, нажмите кнопку продолжить, в противном случае нажмите кнопку назад.'
