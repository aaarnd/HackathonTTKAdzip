...
const ServiceModal = ({ show, onClose }) => {
    ...
    const handleSaveEdit = async (updatedOption) => {
        try {
            console.log('Суета: ', updatedOption.id)
            await updateOption(updatedOption.id, updatedOption);
    ...
    return (
        <>
            <Modal show={show} onHide={onClose} size="lg">
                ...
                <Modal.Footer>
                    <Button variant="secondary" onClick={openOptionCreate}>Добавить</Button>
